...
<!-- Sitemap du site analyses-de-films.
     Genere depuis le contenu reel du depot le 05/08/2026 (BKL-CIN-085, lot L6,
     regenere apres l extension B+ de la page des lecons), jamais recopie a la main.
     AUCUN generateur ne vit dans le depot : ce fichier NE SE MET PAS A JOUR TOUT
     SEUL et vieillira a chaque publication. Sa regeneration a la publication est a
     router en item de backlog propre.
